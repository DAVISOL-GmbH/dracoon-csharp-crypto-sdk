...
```xml
<package id="Dracoon.Crypto.Sdk.Net8" version="5.1.0" />
```
...
```xml
<PackageReference Include="Dracoon.Crypto.Sdk.Net8" Version="5.1.0" />
```

DLL import: The latest DLL can be found [here](https://github.com/dracoon/dracoon-csharp-crypto-sdk/releases).

Note that you also need to include the following dependencies:
1. Bouncy Castle Provider (v2.6.2): https://www.nuget.org/packages/BouncyCastle.Cryptography
